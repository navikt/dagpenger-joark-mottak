...
object TestLibs {
    ...
    const val kafkaEmbedded = "no.nav:kafka-embedded-env:2.0.1"
...
object DagpengerLibs {
    const val streams = "no.nav.dagpenger:streams:0.2.4-SNAPSHOT"
    const val events = "no.nav.dagpenger:events:0.1.9-SNAPSHOT"
